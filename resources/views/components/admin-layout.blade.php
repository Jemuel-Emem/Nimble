...
<head>
    ...
    <style>
        ...
        .sidebar {
            background-color: #6A1B9A; /* Dark violet */
            color: #EDE7F6; /* Light violet text */
        }
        .sidebar img {
            border-radius: 50%;
            width: 80px;
        ...
        .sidebar ul li a {
            color: #EDE7F6; /* Light violet */
            transition: background-color 0.3s;
        }
        .sidebar ul li a:hover {
            background-color: #AB47BC; /* Medium violet */
    ...
    <aside id="sidebar-multi-level-sidebar" class="sidebar fixed top-0 left-0 z-40 w-64 h-screen transition-transform sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto">
            <div class="text-center flex flex-col items-center">
                <i class="ri-drinks-2-line text-6xl text-blue-400"></i>
                <div class="font-bold">NIMBLE</div>
            </div>
            <ul class="space-y-2 font-medium mt-4">
                <li>
                    <a href="" class="flex items-center p-2 rounded-lg hover:bg-gray-700">
                        <i class="ri-pie-chart-box-fill text-blue-200"></i>
                ...
                <li>
                    <a href="#" class="flex items-center p-2 rounded-lg hover:bg-gray-700">
                        <i class="ri-team-fill text-blue-200"></i>
                        <span class="ms-3">Users</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('Addproduct')}}" class="flex items-center p-2 rounded-lg hover:bg-gray-700">
                        <i class="ri-book-shelf-fill text-blue-200"></i>
                        <span class="ms-3">Add Product</span>
                    </a>
                </li>
                <li>
                    <a href="" class="flex items-center p-2 rounded-lg hover:bg-gray-700">
                        <i class="ri-smartphone-fill text-blue-200"></i>
                ...
                <li>
                    <a href="" class="flex items-center p-2 rounded-lg hover:bg-gray-700">
                        <i class="ri-file-list-fill text-blue-200"></i>
                        <span class="ms-3">Trasaction List</span>
                    </a>
                </li>
